          ...
          return (
            <div className="relative flex justify-end items-center gap-2">
              <Dropdown>
                <DropdownTrigger>
                  <ButtonActualizar
                    onClick={() => handleToggle("update", item)}
                  />
                </DropdownTrigger>
                <DropdownMenu>
                  <DropdownItem onClick={() => handleToggle("view", item)}>
                    View
                  </DropdownItem>
                  <DropdownItem onClick={() => handleToggle("edit", item)}>
                    Edit
                  </DropdownItem>
                  <DropdownItem onClick={() => peticionDesactivar(item.id)}>
                    Delete
                  </DropdownItem>
                </DropdownMenu>
              </Dropdown>
