...
var require_highcharts = __commonJS({
 ...
 - ${i4}: ${e4}`, h2 && (l2 += encodeURI(i4) + "=" + encodeURI(e4));
        ...
        let { animate: r, animObject: o, stop: n } = t2, { deg2rad: a, doc: h, svg: l, SVG_NS: d, win: c } = i2, { addEvent: p, attr: u, createElement: g, crisp: f, css: m, defined: x, erase: y, extend: b, fireEvent: v, isArray: S, isFunction: C, isObject: k, isString: M, merge: w, objectEach: A, pick: T, pInt: P, pushUnique: L, replaceNested: O, syncTimeout: D, uniqueKey: E } = s;
        class I {
          _defaultGetter(t3) {
          ...
          align(t3, e3, i3, s2 = true) {
            ...
            let u2 = T(i3, l2[p2], l2), g2 = t3.align, f2 = t3.verticalAlign;
          ...
          animate(t3, e3, i3) {
            let s2 = o(T(e3, this.renderer.globalAnimation, true)), n2 = s2.defer;
          ...
          attr(t3, e3, i3, s2) {
            ...
            return "string" == typeof t3 && void 0 !== e3 && (a2 = t3, (t3 = {})[a2] = e3), "string" == typeof t3 ? l2 = (this[t3 + "Getter"] || this._defaultGetter).call(this, t3, r2) : (A(t3, function(e4, i4) {
          ...
          complexColor(t3, i3, s2) {
            ...
            v(this.renderer, "complexColor", { args: arguments }, function() {
              if (t3.radialGradient ? n2 = "radialGradient" : t3.linearGradient && (n2 = "linearGradient"), n2) {
                if (a2 = t3[n2], l2 = r2.gradients, d2 = t3.stops, u2 = s2.radialReference, S(a2) && (t3[n2] = a2 = { x1: a2[0], y1: a2[1], x2: a2[2], y2: a2[3], gradientUnits: "userSpaceOnUse" }), "radialGradient" === n2 && u2 && !x(a2.gradientUnits) && (h2 = a2, a2 = w(a2, r2.getRadialAttr(u2, h2), { gradientUnits: "userSpaceOnUse" })), A(a2, function(t4, e3) {
                  "id" !== e3 && f2.push(e3, t4);
                }), A(d2, function(t4) {
                  f2.push(t4);
          ...
          getBBox(t3, e3) {
            let i3, s2, r2, o2;
            let { alignValue: n2, element: a2, renderer: h2, styles: l2, textStr: d2 } = this, { cache: c2, cacheKeys: p2 } = h2, u2 = a2.namespaceURI === this.SVG_NS, g2 = T(e3, this.rotation, 0), f2 = h2.styledMode ? a2 && I.prototype.getStyle.call(a2, "font-size") : l2.fontSize;
          ...
          getRotatedBox(t3, e3) {
            let { x: i3, y: s2, width: r2, height: o2 } = t3, { alignValue: n2, translateY: h2, rotationOriginX: l2 = 0, rotationOriginY: d2 = 0 } = this, c2 = { right: 1, center: 0.5 }[n2 || 0] || 0, p2 = Number(this.element.getAttribute("y") || 0) - (h2 ? 0 : s2), u2 = e3 * a, g2 = (e3 - 90) * a, f2 = Math.cos(u2), m2 = Math.sin(u2), x2 = r2 * f2, y2 = r2 * m2, b2 = Math.cos(g2), v2 = Math.sin(g2), [[S2, C2], [k2, M2]] = [l2, d2].map((t4) => [t4 - t4 * f2, t4 * m2]), w2 = i3 + c2 * (r2 - x2) + S2 + M2 + p2 * b2, A2 = w2 + x2, T2 = A2 - o2 * b2, P2 = T2 - x2, L2 = s2 + p2 - c2 * y2 - C2 + k2 + p2 * v2, O2 = L2 + y2, D2 = O2 - o2 * v2, E2 = D2 - y2, I2 = Math.min(w2, A2, T2, P2), j = Math.min(L2, O2, D2, E2), B = Math.max(w2, A2, T2, P2) - I2, R = Math.max(L2, O2, D2, E2) - j;
            return { x: I2, y: j, width: B, height: R, polygon: [[w2, L2], [A2, O2], [T2, D2], [P2, E2]] };
          }
          getStyle(t3) {
          ...
          titleSetter(t3) {
            ...
            e3.insertBefore ? e3.insertBefore(i3, e3.firstChild) : e3.appendChild(i3), i3.textContent = O(T(t3, ""), [/<[^>]*>/g, ""]).replace(/&lt;/g, "<").replace(/&gt;/g, ">");
          }
          toFront() {
            let t3 = this.element;
          ...
          updateTransform(t3 = "transform") {
            ...
            x(i3) && d2.push("matrix(" + i3.join(",") + ")"), s2 && (d2.push("rotate(" + s2 + " " + T(r2, e3.getAttribute("x"), 0) + " " + T(o2, e3.getAttribute("y") || 0) + ")"), ((_a = this.text) == null ? void 0 : _a.element.tagName) === "SPAN" && this.text.attr({ rotation: s2, rotationOriginX: (r2 || 0) - this.padding, rotationOriginY: (o2 || 0) - this.padding })), (x(n2) || x(a2)) && d2.push("scale(" + T(n2, 1) + " " + T(a2, 1) + ")"), d2.length && !(this.text || this).textPath && e3.setAttribute(t3, d2.join(" "));
          }
        ...
        class W {
          constructor(t3, e3, i3, s2, r2, o2, n2) {
            ...
            n2 || l2.css(this.getStyle(s2 || {})), t3.appendChild(d2), k(t3, "dir", "ltr"), -1 === t3.innerHTML.indexOf("xmlns") && k(d2, "xmlns", this.SVG_NS), this.box = d2, this.boxWrapper = l2, this.alignedObjects = [], this.url = this.getReferenceURL(), this.createElement("desc").add().element.appendChild(g.createTextNode("Created with Highcharts 11.4.7")), this.defs = this.createElement("defs").add(), this.allowHTML = o2, this.forExport = r2, this.styledMode = n2, this.gradients = {}, this.cache = {}, this.cacheKeys = [], this.imgCount = 0, this.rootFontSize = l2.getStyle("font-size"), this.setSize(e3, i3, false), f && t3.getBoundingClientRect && ((a2 = function() {
              A(t3, { left: 0, top: 0 }), h2 = t3.getBoundingClientRect(), A(t3, { left: Math.ceil(h2.left) - h2.left + "px", top: Math.ceil(h2.top) - h2.top + "px" });
          ...
          getReferenceURL() {
            if ((f || x) && g.getElementsByTagName("base").length) {
              if (!T(d)) {
                ...
                A(i3, { position: "fixed", top: 0, left: 0, zIndex: 9e5 });
          ...
          symbol(t3, e3, i3, s2, r2, o2) {
            ...
            if (m2) "number" == typeof e3 && (a2 = m2.call(this.symbols, e3 || 0, i3 || 0, s2 || 0, r2 || 0, o2)), n2 = this.path(a2), d2.styledMode || n2.attr("fill", "none"), L(n2, { symbolName: f2 || void 0, x: e3, y: i3, width: s2, height: r2 }), o2 && L(n2, o2);
              ...
              }), T(e3) && s3.attr({ x: e3, y: i3 }), s3.isImg = true, T(s3.imgwidth) && T(s3.imgheight) ? l2(s3) : (s3.attr({ width: 0, height: 0 }), M("img", { onload: function() {
                let t4 = p[d2.chartIndex];
                0 === this.width && (A(this, { position: "absolute", top: "-999em" }), g.body.appendChild(this)), v[h2] = { width: this.width, height: this.height }, s3.imgwidth = this.width, s3.imgheight = this.height, s3.element && l2(s3), this.parentNode && this.parentNode.removeChild(this), d2.imgCount--, d2.imgCount || !t4 || t4.hasLoaded || t4.onload();
          ...
          text(t3, e3, i3, s2) {
            ...
            r2.x = Math.round(e3 || 0), i3 && (r2.y = Math.round(i3)), T(t3) && (r2.text = t3);
        ...
        return class {
          ...
          addLabel() {
            ...
            let A = { axis: i3, chart: r2, dateTimeLabelFormat: C, isFirst: x, isLast: y, pos: g, tick: e3, tickPositionInfo: v, value: w };
            l(this, "labelFormat", A);
            let T = (e4) => f.formatter ? f.formatter.call(e4, e4) : f.format ? (e4.text = i3.defaultLabelFormatter.call(e4), t2.format(f.format, e4, r2)) : i3.defaultLabelFormatter.call(e4), P = T.call(A, A), L = k && k.list;
            L ? e3.shortenLabel = function() {
              for (M = 0; M < L.length; M++) if (h(A, { dateTimeLabelFormat: L[M] }), S.attr({ text: T.call(A, A) }), S.getBBox().width < i3.getSlotWidth(e3) - 2 * (f.padding || 0)) return;
              S.attr({ text: "" });
        ...
        class N {
          ...
          defaultLabelFormatter() {
            let t3 = this.axis, { numberFormatter: e3 } = this.chart, i3 = T(this.value) ? this.value : NaN, s2 = t3.chart.time, r2 = t3.categories, o2 = this.dateTimeLabelFormat, n2 = c.lang, a2 = n2.numericSymbols, h2 = n2.numericSymbolMagnitude || 1e3, l2 = t3.logarithmic ? Math.abs(i3) : t3.tickInterval, d2 = a2 && a2.length, p2, u2;
            if (r2) u2 = `${this.value}`;
            ...
            k(this, "getSeriesExtremes", null, function() {
              e3.hasVisibleSeries = false, e3.dataMin = e3.dataMax = e3.threshold = void 0, e3.softThreshold = !e3.isXAxis, e3.series.forEach((i3) => {
                if (i3.reserveSpace()) {
                  ...
                  if (e3.hasVisibleSeries = true, e3.positiveValuesOnly && 0 >= (o2 || 0) && (o2 = void 0), e3.isXAxis) (r2 = i3.xData) && r2.length && (r2 = e3.logarithmic ? r2.filter((t4) => t4 > 0) : r2, n2 = (t3 = i3.getXExtremes(r2)).min, a2 = t3.max, T(n2) || n2 instanceof Date || (r2 = r2.filter(T), n2 = (t3 = i3.getXExtremes(r2)).min, a2 = t3.max), r2.length && (e3.dataMin = Math.min(E(e3.dataMin, n2), n2), e3.dataMax = Math.max(E(e3.dataMax, a2), a2)));
                  else {
                    let t4 = i3.applyExtremes();
                    T(t4.dataMin) && (n2 = t4.dataMin, e3.dataMin = Math.min(E(e3.dataMin, n2), n2)), T(t4.dataMax) && (a2 = t4.dataMax, e3.dataMax = Math.max(E(e3.dataMax, a2), a2)), y(o2) && (e3.threshold = o2), (!s2.softThreshold || e3.positiveValuesOnly) && (e3.softThreshold = false);
                  }
                }
              });
          ...
          translate(t3, e3, i3, s2, r2, o2) {
            ...
            return p2 || (p2 = n2.transA), i3 && (d2 *= -1, c2 = n2.len), n2.reversed && (d2 *= -1, c2 -= d2 * (n2.sector || n2.len)), e3 ? (u2 = (t3 = t3 * d2 + c2 - h2) / p2 + a2, l2 && (u2 = n2.lin2val(u2))) : (l2 && (t3 = n2.val2lin(t3)), u2 = d2 * (t3 - a2) * p2 + c2 + d2 * h2 + (T(o2) ? p2 * o2 : 0), n2.isRadial || (u2 = x(u2))), u2;
          }
          toPixels(t3, e3) {
          ...
          getPlotLinePath(t3) {
            ...
            return k(this, "getPlotLinePath", v2, function(t4) {
              u2 = f2 = (c2 = m(c2 = E(c2, e3.translate(n2, void 0, void 0, o2)), -1e5, 1e5)) + d2, g2 = x2 = h2 - c2 - d2, T(c2) ? e3.horiz ? (g2 = r2, x2 = h2 - e3.bottom + (e3.options.isInternal ? 0 : i3.scrollablePixelsY || 0), u2 = f2 = b2(u2, s2, s2 + e3.width)) : (u2 = s2, f2 = l2 - e3.right + (i3.scrollablePixelsX || 0), g2 = x2 = b2(g2, r2, r2 + e3.height)) : (y2 = true, p2 = false), t4.path = y2 && !p2 ? void 0 : i3.renderer.crispLine([["M", u2, g2], ["L", f2, x2]], a2 || 1);
            }), v2.path;
          }
          ...
          nameToX(t3) {
            let e3 = A(this.options.categories), i3 = e3 ? this.categories : this.names, s2 = t3.options.x, r2;
          ...
          setTickInterval(t3) {
            var _a, _b, _c, _d;
            let { categories: e3, chart: i3, dataMax: s2, dataMin: r2, dateTime: o2, isXAxis: n2, logarithmic: a2, options: h2, softThreshold: l2 } = this, d2 = T(this.threshold) ? this.threshold : void 0, c2 = this.minRange || 0, { ceiling: p2, floor: u2, linkedTo: g2, softMax: f2, softMin: m2 } = h2, b2 = T(g2) && ((_a = i3[this.coll]) == null ? void 0 : _a[g2]), v2 = h2.tickPixelInterval, C2 = h2.maxPadding, M2 = h2.minPadding, w2 = 0, A2, P2 = T(h2.tickInterval) && h2.tickInterval >= 0 ? h2.tickInterval : void 0, L2, O2, D2, I2;
            if (o2 || e3 || b2 || this.getTickAmount(), D2 = E(this.userMin, h2.min), I2 = E(this.userMax, h2.max), b2 ? (this.linkedParent = b2, A2 = b2.getExtremes(), this.min = E(A2.min, A2.dataMin), this.max = E(A2.max, A2.dataMax), h2.type !== b2.options.type && S(11, true, i3)) : (l2 && y(d2) && T(s2) && T(r2) && (r2 >= d2 ? (L2 = d2, M2 = 0) : s2 <= d2 && (O2 = d2, C2 = 0)), this.min = E(D2, L2, r2), this.max = E(I2, O2, s2)), T(this.max) && T(this.min) && (a2 && (this.positiveValuesOnly && !t3 && 0 >= Math.min(this.min, E(r2, this.min)) && S(10, true, i3), this.min = x(a2.log2lin(this.min), 16), this.max = x(a2.log2lin(this.max), 16)), this.range && T(r2) && (this.userMin = this.min = D2 = Math.max(r2, this.minFromRange() || 0), this.userMax = I2 = this.max, this.range = void 0)), k(this, "foundExtremes"), this.adjustForMinRange(), T(this.min) && T(this.max)) {
              if (!T(this.userMin) && T(m2) && m2 < this.min && (this.min = D2 = m2), !T(this.userMax) && T(f2) && f2 > this.max && (this.max = I2 = f2), e3 || this.axisPointRange || ((_b = this.stacking) == null ? void 0 : _b.usePercentage) || b2 || !(w2 = this.max - this.min) || (!y(D2) && M2 && (this.min -= w2 * M2), y(I2) || !C2 || (this.max += w2 * C2)), !T(this.userMin) && T(u2) && (this.min = Math.max(this.min, u2)), !T(this.userMax) && T(p2) && (this.max = Math.min(this.max, p2)), l2 && T(r2) && T(s2)) {
                let t4 = d2 || 0;
            ...
            if (this.min !== this.max && T(this.min) && T(this.max) ? b2 && !P2 && v2 === b2.options.tickPixelInterval ? this.tickInterval = P2 = b2.tickInterval : this.tickInterval = E(P2, this.tickAmount ? w2 / Math.max(this.tickAmount - 1, 1) : void 0, e3 ? 1 : w2 * v2 / Math.max(this.len, v2)) : this.tickInterval = 1, n2 && !t3) {
          ...
          setTickPositions() {
            ...
            this.tickPositions = a2, this.paddedTicks = a2.slice(0), this.trimTicks(a2, o2, n2), !this.isLinked && T(this.min) && T(this.max) && (this.single && a2.length < 2 && !this.categories && !this.series.some((t4) => t4.is("heatmap") && "between" === t4.options.pointPlacement) && (this.min -= 0.5, this.max += 0.5), e3 || h2 || this.adjustTickAmount()), k(this, "afterSetTickPositions");
          }
          trimTicks(t3, e3, i3) {
          ...
          adjustTickAmount() {
            ...
            if (T(a2) && (u2 = a2 < 0.5 ? Math.ceil(a2 * (n2 - 1)) : Math.floor(a2 * (n2 - 1)), r2.reversed && (u2 = n2 - 1 - u2)), t3.hasData() && T(s2) && T(i3)) {
              let a3 = () => {
          ...
          unsquish() {
            ...
            if (i3) {
              if (!t3.staggerLines && (T(o2) ? p2 = [o2] : r2 < t3.autoRotationLimit && (p2 = t3.autoRotation)), p2) {
                let t4, e4;
                for (let i4 of p2) (i4 === o2 || i4 && i4 >= -90 && i4 <= 90) && (e4 = (t4 = h2(Math.abs(n2 / Math.sin(u * i4)))) + Math.abs(i4 / 360)) < c2 && (c2 = e4, d2 = i4, l2 = t4);
              }
            } else l2 = h2(0.75 * n2);
            return this.autoRotation = p2, this.labelRotation = E(d2, T(o2) ? o2 : 0), t3.step ? s2 : l2;
          }
          getSlotWidth(t3) {
          ...
          getOffset() {
            let t3 = this, { chart: e3, horiz: i3, options: s2, side: r2, ticks: o2, tickPositions: n2, coll: a2 } = t3, h2 = e3.inverted && !t3.isZAxis ? [1, 0, 3, 2][r2] : r2, l2 = t3.hasData(), d2 = s2.title, c2 = s2.labels, p2 = T(s2.crossing), u2 = e3.axisOffset, g2 = e3.clipOffset, f2 = [-1, 1, 1, -1][r2], m2, x2 = 0, b2, v2 = 0, S2 = 0, C2, M2;
        ...
        let { arrayMax: i2, arrayMin: s, defined: r, destroyObjectProperties: o, erase: n, fireEvent: a, merge: h, objectEach: l, pick: d } = e2;
        class c {
          static compose(e3) {
          ...
          render() {
            a(this, "render");
            let { axis: t3, options: e3 } = this, { horiz: i3, logarithmic: s2 } = t3, { color: o2, events: n2, zIndex: c2 = 0 } = e3, p = {}, u = t3.chart.renderer, g = e3.to, f = e3.from, m = e3.value, x = e3.borderWidth, y = e3.label, { label: b, svgElem: v } = this, S = [], C, k = r(f) && r(g), M = r(m), w = !v, A = { class: "highcharts-plot-" + (k ? "band " : "line ") + (e3.className || "") }, T = k ? "bands" : "lines";
            if (!t3.chart.styledMode && (M ? (A.stroke = o2 || "#999999", A["stroke-width"] = d(e3.width, 1), e3.dashStyle && (A.dashstyle = e3.dashStyle)) : k && (A.fill = o2 || "#e6e9ff", x && (A.stroke = e3.borderColor, A["stroke-width"] = x))), p.zIndex = c2, T += "-" + c2, (C = t3.plotLinesAndBandsGroups[T]) || (t3.plotLinesAndBandsGroups[T] = C = u.g("plot-" + T).attr(p).add()), v || (this.svgElem = v = u.path().attr(A).add(C)), r(m)) S = t3.getPlotLinePath({ value: (s2 == null ? void 0 : s2.log2lin(m)) ?? m, lineWidth: v.strokeWidth(), acrossPanes: e3.acrossPanes });
            else {
              if (!(r(f) && r(g))) return;
              S = t3.getPlotBandPath((s2 == null ? void 0 : s2.log2lin(f)) ?? f, (s2 == null ? void 0 : s2.log2lin(g)) ?? g, e3);
            }
            return !this.eventsAdded && n2 && (l(n2, (t4, e4) => {
              v == null ? void 0 : v.on(e4, (t5) => {
                n2[e4].apply(this, [t5]);
              });
            }), this.eventsAdded = true), (w || !v.d) && (S == null ? void 0 : S.length) ? v.attr({ d: S }) : v && (S ? (v.show(), v.animate({ d: S })) : v.d && (v.hide(), b && (this.label = b = b.destroy()))), y && (r(y.text) || r(y.formatter)) && (S == null ? void 0 : S.length) && t3.width > 0 && t3.height > 0 && !S.isFlat ? (y = h({ align: i3 && k ? "center" : void 0, x: i3 ? !k && 4 : 10, verticalAlign: !i3 && k ? "middle" : void 0, y: i3 ? k ? 16 : 10 : k ? 6 : -4, rotation: i3 && !k ? 90 : 0 }, y), this.renderLabel(y, S, k, c2)) : b && b.hide(), this;
          }
          renderLabel(t3, e3, r2, o2) {
            let n2 = this.axis, a2 = n2.chart.renderer, l2 = this.label;
            l2 || (this.label = l2 = a2.text(this.getLabelText(t3), 0, 0, t3.useHTML).attr({ align: t3.textAlign || t3.align, rotation: t3.rotation, class: "highcharts-plot-" + (r2 ? "band" : "line") + "-label " + (t3.className || ""), zIndex: o2 }), n2.chart.styledMode || l2.css(h({ fontSize: "0.8em", textOverflow: "ellipsis" }, t3.style)), l2.add());
        ...
        var n;
        let { animObject: a } = t2, { format: h } = e2, { composed: l, doc: d, isSafari: c } = i2, { distribute: p } = s, { addEvent: u, clamp: g, css: f, discardElement: m, extend: x, fireEvent: y, isArray: b, isNumber: v, isString: S, merge: C, pick: k, pushUnique: M, splat: w, syncTimeout: A } = o;
        class T {
          constructor(t3, e3, i3) {
          ...
          getPosition(t3, e3, i3) {
            ...
            let A2 = !this.followPointer && k(i3.ttBelow, !d2 && !a2 === w2), T2 = function(t4, e4, i4, r3, n3, a3, h3) {
              ...
              false !== T2.apply(0, S2) ? false !== P.apply(0, C2) || M2 || (L(true), O()) : M2 ? u2.x = u2.y = 0 : (L(true), O());
            };
            return (a2 && !d2 || this.len > 1) && L(), O(), u2;
          }
          hide(t3) {
            let e3 = this;
            o.clearTimeout(this.hideTimer), t3 = k(t3, this.options.hideDelay), this.isHidden || (this.hideTimer = A(function() {
              let i3 = e3.getLabel();
          ...
          refresh(t3, e3) {
            let { chart: i3, options: s2, pointer: r2, shared: n2 } = this, a2 = w(t3), l2 = a2[0], d2 = [], c2 = s2.format, p2 = s2.formatter || this.defaultFormatter, u2 = i3.styledMode, g2 = {}, f2 = this.allowShared;
            if (!s2.enabled || !l2.series) return;
            o.clearTimeout(this.hideTimer), this.allowShared = !(!b(t3) && t3.series && t3.series.noSharedTooltip), f2 = f2 && !this.allowShared, this.followPointer = !this.split && l2.series.tooltipOptions.followPointer;
            let m2 = this.getAnchor(t3, e3), x2 = m2[0], v2 = m2[1];
            ...
            let C2 = S(c2) ? h(c2, g2, i3) : p2.call(g2, this), M2 = l2.series;
            if (this.distance = k(M2.tooltipOptions.distance, 16), false === C2) this.hide();
            else {
              if (this.split && this.allowShared) this.renderSplit(C2, a2);
              else {
                let t4 = x2, o2 = v2;
                if (e3 && r2.isDirectTouch && (t4 = e3.chartX - i3.plotLeft, o2 = e3.chartY - i3.plotTop), i3.polar || false === M2.options.clip || a2.some((e4) => r2.isDirectTouch || e4.series.shouldShowTooltip(t4, o2))) {
                  let t5 = this.getLabel(f2 && this.tt || {});
                  (!s2.style.width || u2) && t5.css({ width: (this.outside ? this.getPlayingField() : i3.spacingBox).width + "px" }), t5.attr({ class: this.getClassName(l2), text: C2 && C2.join ? C2.join("") : C2 }), u2 || t5.attr({ stroke: s2.borderColor || l2.color || M2.color || "#666666" }), this.updatePosition({ plotX: x2, plotY: v2, negative: l2.negative, ttBelow: l2.ttBelow, h: m2[2] || 0 });
                } else {
                  this.hide();
                  return;
                }
          ...
          renderSplit(t3, e3) {
            var _a;
            let i3 = this, { chart: s2, chart: { chartWidth: r2, chartHeight: o2, plotHeight: n2, plotLeft: a2, plotTop: h2, scrollablePixelsY: l2 = 0, scrollablePixelsX: u2, styledMode: f2 }, distance: m2, options: y2, options: { positioner: b2 }, pointer: v2 } = i3, { scrollLeft: C2 = 0, scrollTop: M2 = 0 } = ((_a = s2.scrollablePlotArea) == null ? void 0 : _a.scrollingContainer) || {}, w2 = i3.outside && "number" != typeof u2 ? d.documentElement.getBoundingClientRect() : { left: C2, right: C2 + r2, top: M2, bottom: M2 + o2 }, A2 = i3.getLabel(), T2 = this.renderer || s2.renderer, P = !!(s2.xAxis[0] && s2.xAxis[0].opposite), { left: L, top: O } = v2.getChartPosition(), D = h2 + M2, E = 0, I = n2 - l2;
              ...
              if (false !== s3 && "" !== s3) {
                let o3 = e3[r3 - 1] || { isHeader: true, plotX: e3[0].plotX, plotY: n2, series: {} }, l3 = o3.isHeader, d2 = l3 ? i3 : o3.series, c2 = d2.tt = function(t5, e4, s4) {
                  ...
                  if (!r4) {
                    ...
                    f2 || (t6.fill = y2.backgroundColor, t6["stroke-width"] = y2.borderWidth ?? 1), r4 = T2.label("", 0, 0, y2[o4 ? "headerShape" : "shape"], void 0, void 0, y2.useHTML).addClass(i3.getClassName(e4, true, o4)).attr(t6).add(A2);
                  }
            ...
            if (N && z && W) {
              let { width: t4, height: e4, x: i4, y: s3 } = A2.getBBox();
              W.setSize(t4 + i4, e4 + s3, false), z.style.left = R.left + "px", z.style.top = O + "px";
            }
            c && A2.attr({ opacity: 1 === A2.opacity ? 0.999 : 1 });
          }
          drawTracker() {
        ...
        class k {
          ...
          setState(e3, i3) {
            ...
            let M = o2.halo, w = this.graphic || C2, A = w && w.visibility || "inherit";
            M && M.size && w && "hidden" !== A && !this.isCluster ? (x2 || (s2.halo = x2 = g2.renderer.path().add(w.parentGroup)), x2.show()[i3 ? "animate" : "attr"]({ d: this.haloPath(M.size) }), x2.attr({ class: "highcharts-halo highcharts-color-" + b(this.colorIndex, s2.colorIndex) + (this.className ? " " + this.className : ""), visibility: A, zIndex: -1 }), x2.point = this, g2.styledMode || x2.attr(c({ fill: this.color || s2.color, "fill-opacity": M.opacity }, t2.filterUserAttributes(M.attributes || {})))) : ((_a = x2 == null ? void 0 : x2.point) == null ? void 0 : _a.haloPath) && !x2.point.destroyed && x2.animate({ d: x2.point.haloPath(0) }, null, x2.hide), p(this, "afterSetState", { state: e3 });
          }
          haloPath(t3) {
            let e3 = this.pos();
        ...
        return function(t3) {
          function e3(t4, e4, o) {
            var _a;
            let n = this.legendItem = this.legendItem || {}, { chart: a, options: h } = this, { baseline: l = 0, symbolWidth: d, symbolHeight: c } = t4, p = this.symbol || "circle", u = c / 2, g = a.renderer, f = n.group, m = l - Math.round(c * (o ? 0.4 : 0.3)), x = {}, y, b = h.marker, v = 0;
            if (a.styledMode || (x["stroke-width"] = Math.min(h.lineWidth || 0, 24), h.dashStyle ? x.dashstyle = h.dashStyle : "square" === h.linecap || (x["stroke-linecap"] = "round")), n.line = g.path().addClass("highcharts-graph").attr(x).add(f), o && (n.area = g.path().addClass("highcharts-area").add(f)), x["stroke-linecap"] && (v = Math.min(n.line.strokeWidth(), d) / 2), d) {
              ...
              n.line.attr({ d: t5 }), (_a = n.area) == null ? void 0 : _a.attr({ d: [...t5, ["L", d - v, l], ["L", v, l]] });
            }
        ...
        class X {
          ...
          init(t3, e3) {
            ...
            s2.linkedSeries = [], s2.bindAxes(), T(s2, { name: o2.name, state: "", visible: n2, selected: true === o2.selected }), u(this, o2);
            let a2 = o2.events;
          ...
          bindAxes() {
            ...
            L(this, "bindAxes", null, function() {
              (e3.axisTypes || []).forEach(function(r2) {
                ...
                }), e3[r2] || e3.optionalAxis === r2 || A(18, true, s2);
              });
          ...
          setDataSortingOptions() {
            let t3 = this.options;
            T(this, { requireSorting: false, sorted: false, enabledDataSorting: true, allowDG: false }), C(t3.pointRange) || (t3.pointRange = 1);
          }
          setOptions(t3) {
            var _a, _b;
            let e3;
          ...
          setData(t3, e3 = true, i3, s2) {
            ...
            if (l2 && l2.enabled && (t3 = this.sortData(t3)), h2.options.chart.allowMutatingData && false !== s2 && k2 && n2 && !r2.cropped && !r2.hasGroupedData && r2.visible && !r2.boosted && (b2 = this.updateData(t3, i3)), !b2) {
              ...
              for (u2 && B(u2[0]) && A(14, true, h2), r2.data = [], r2.options.data = r2.userOptions.data = t3, x2 = n2; x2--; ) (_a = o2[x2]) == null ? void 0 : _a.destroy();
          ...
          getProcessedData(t3) {
            ...
            let m2 = O([r2 ? p2.map(r2.log2lin) : p2], () => e3.requireSorting && !g2 && A(15, false, e3.chart));
          ...
          generatePoints() {
            ...
            for (h2 && a2 && (this.options.keys = false), g2 = 0; g2 < o2; g2++) p2 = n2 + g2, a2 ? ((u2 = new r2(this, [i3[g2]].concat(G(s2[g2])))).dataGroup = this.groupMap[d2 + g2], u2.dataGroup.options && (u2.options = u2.dataGroup.options, T(u2, u2.dataGroup.options), delete u2.dataLabels)) : (u2 = f2[p2]) || void 0 === e3[p2] || (f2[p2] = u2 = new r2(this, e3[p2], i3[g2])), u2 && (u2.index = a2 ? d2 + g2 : p2, l2[g2] = u2);
          ...
          update(t3, e3) {
            ...
            } else A(17, true, s2, { missingModuleFor: u2 });
        ...
        return X.defaultOptions = n, X.types = a.seriesTypes, X.registerType = a.registerSeriesType, T(X.prototype, { axisTypes: ["xAxis", "yAxis"], coll: "series", colorCounter: 0, directTouch: false, invertible: true, isCartesian: true, kdAxisArray: ["clientX", "plotY"], parallelArrays: ["x", "y"], pointClass: o, requireSorting: true, sorted: true }), a.series = X, X;
        ...
        var h;
        let { animObject: l, setAnimation: d } = t2, { registerEventOptions: c } = e2, { composed: p, marginNames: u } = i2, { distribute: g } = o, { format: f } = n, { addEvent: m, createElement: x, css: y, defined: b, discardElement: v, find: S, fireEvent: C, isNumber: k, merge: M, pick: w, pushUnique: A, relativeLength: T, stableSort: P, syncTimeout: L } = a;
        class O {
          constructor(t3, e3) {
        ...
        class Q {
          ...
          propFromSeries() {
            ...
            ["inverted", "angular", "polar"].forEach(function(n2) {
              for (e3 = A[r2.type], i3 = r2[n2] || e3 && e3.prototype[n2], t3 = o2 && o2.length; !i3 && t3--; ) (e3 = A[o2[t3].type]) && e3.prototype[n2] && (i3 = true);
              s2[n2] = i3;
            });
          }
          linkSeries(t3) {
          ...
          showLoading(t3) {
            ...
            o2 || (e3.loadingDiv = o2 = L("div", { className: "highcharts-loading highcharts-loading-hidden" }, null, e3.container)), n2 || (e3.loadingSpan = n2 = L("span", { className: "highcharts-loading-inner" }, null, o2), T(e3, "redraw", r2)), o2.className = "highcharts-loading", p.setElementHTML(n2, V(t3, i3.lang.loading, "")), e3.styledMode || (O(o2, R(s2.style, { zIndex: 10 })), O(n2, s2.labelStyle), e3.loadingShown || (O(o2, { opacity: 0, display: "" }), g(o2, { opacity: s2.style.opacity || 0.5 }, { duration: s2.showDuration || 0 }))), e3.loadingShown = true, r2();
          }
          hideLoading() {
          ...
          transform(t3) {
            ...
            for (let t4 of ((_a = this.hoverPoints) == null ? void 0 : _a.forEach((t5) => t5.setState()), e3)) {
              ...
              let M2 = t4.toValue(C2, true) + (o2 ? 0 : u2 * k2), w2 = t4.toValue(C2 + p2 / v2, true) - (o2 ? 0 : u2 * k2 || 0), A2 = t4.allExtremes;
              if (M2 > w2 && ([M2, w2] = [w2, M2]), 1 === v2 && !r2 && "yAxis" === t4.coll && !A2) {
        ...
        class g {
          ...
          applyFixed() {
            ...
            let S = u2 - o2[0] - 1, C = p2 - o2[3] - 1, k = u2 + c2 + o2[2] + 1, M = p2 + g2 + o2[1] + 1, w = p2 + g2 - f, A = u2 + c2 - m, T = [["M", 0, 0]];
            f ? T = [["M", 0, S], ["L", p2 - 1, S], ["L", p2 - 1, k], ["L", 0, k], ["Z"], ["M", w, S], ["L", n2, S], ["L", n2, k], ["L", w, k], ["Z"]] : m && (T = [["M", C, 0], ["L", C, u2 - 1], ["L", M, u2 - 1], ["L", M, 0], ["Z"], ["M", C, A], ["L", C, a2], ["L", M, a2], ["L", M, A], ["Z"]]), "adjustHeight" !== t3.redrawTrigger && this.mask.attr({ d: T });
          }
          moveFixedElements() {
            let t3;
        ...
        class v extends r {
          ...
          translate() {
            ...
            i3.pointPadding && (S = Math.ceil(S)), r.prototype.translate.apply(t3), t3.points.forEach(function(s3) {
              let r2 = y(s3.yBottom, v2), o3 = 999 + Math.abs(r2), g2 = s3.plotX || 0, C = d(s3.plotY, -o3, a2.len + o3), k, M = Math.min(C, r2), w = Math.max(C, r2) - M, A = u2, T = g2 + f2, P = S;
              l2 && Math.abs(w) < l2 && (w = l2, k = !a2.reversed && !s3.negative || a2.reversed && s3.negative, m(h2) && m(b2) && s3.y === h2 && b2 <= h2 && (a2.min || 0) < h2 && (x2 !== b2 || (a2.max || 0) <= h2) && (k = !k, s3.negative = !s3.negative), M = Math.abs(M - v2) > l2 ? r2 - l2 : v2 - (k ? l2 : 0)), p(s3.options.pointWidth) && (T -= Math.round(((A = P = Math.ceil(s3.options.pointWidth)) - u2) / 2)), i3.centerInCategory && !i3.stacking && (T = t3.adjustForMissingColumns(T, A, s3, c2)), s3.barX = T, s3.pointWidth = A, s3.tooltipPos = e3.inverted ? [d(a2.len + a2.pos - e3.plotLeft - C, a2.pos - e3.plotLeft, a2.len + a2.pos - e3.plotLeft), n2.len + n2.pos - e3.plotTop - T - P / 2, w] : [n2.left - e3.plotLeft + T + P / 2, d(C + a2.pos - e3.plotTop, a2.pos - e3.plotTop, a2.len + a2.pos - e3.plotTop), w], s3.shapeType = t3.pointClass.prototype.shapeType || "roundedRect", s3.shapeArgs = t3.crispCol(T, s3.isNull ? v2 : M, P, s3.isNull ? 0 : w);
            ...
            h(this, "drawDataLabels"), ((_a = i4.hasDataLabels) == null ? void 0 : _a.call(i4)) && (e4 = this.initDataLabels(k), t4.forEach((t5) => {
              ...
              f(b(y2, t5.dlOptions || ((_a2 = t5.options) == null ? void 0 : _a2.dataLabels))).forEach((c4, f2) => {
                let m3 = c4.enabled && (t5.visible || t5.dataLabelOnHidden) && (!t5.isNull || t5.dataLabelOnNull) && function(t6, e5) {
                  ...
                  return true;
                }(t5, c4), { backgroundColor: y3, borderColor: b2, distance: v2, style: S3 = {} } = c4, C2, k2, M, w, A = {}, T = r2[f2], P = !T, L;
                m3 && (k2 = u(c4[t5.formatPrefix + "Format"], c4.format), C2 = t5.getLabelConfig(), M = n(k2) ? o(k2, C2, s3) : (c4[t5.formatPrefix + "Formatter"] || c4.formatter).call(C2, c4), w = c4.rotation, !s3.styledMode && (S3.color = u(c4.color, S3.color, d(i4.color) ? i4.color : void 0, "#000000"), "contrast" === S3.color ? ("none" !== y3 && (L = y3), t5.contrastColor = l2.getContrast("auto" !== L && L || t5.color || i4.color), S3.color = L || !n(v2) && c4.inside || 0 > g(v2 || 0) || a2.stacking ? t5.contrastColor : x2) : delete t5.contrastColor, a2.cursor && (S3.cursor = a2.cursor)), A = { r: c4.borderRadius || 0, rotation: w, padding: c4.padding, zIndex: 1 }, s3.styledMode || (A.fill = "auto" === y3 ? t5.color : y3, A.stroke = "auto" === b2 ? t5.color : b2, A["stroke-width"] = c4.borderWidth), p(A, (t6, e5) => {
                  void 0 === t6 && delete A[e5];
                })), !T || m3 && n(M) && !!T.div == !!c4.useHTML && (T.rotation && c4.rotation || T.rotation === c4.rotation) || (T = void 0, P = true), m3 && n(M) && (T ? A.text = M : (T = l2.label(M, 0, 0, c4.shape, void 0, void 0, c4.useHTML, void 0, "data-label")).addClass(" highcharts-data-label-color-" + t5.colorIndex + " " + (c4.className || "") + (c4.useHTML ? " highcharts-tracker" : "")), T && (T.options = c4, T.attr(A), s3.styledMode || T.css(S3).shadow(c4.shadow), h(T, "beforeAddingDataLabel", { labelOptions: c4, point: t5 }), T.added || T.add(e4), i4.alignDataLabel(t5, T, c4, void 0, P), T.isActive = true, r2[f2] && r2[f2] !== T && r2[f2].destroy(), r2[f2] = T));
              });
              let c3 = r2.length;
            ...
            t3.visible && ((_a = t3.hasDataLabels) == null ? void 0 : _a.call(t3)) && (e4.forEach((t4) => {
              ...
              l2 && (t3.sortByAngle(e5, n3 - 0.5), C > 0 && (f2 = Math.max(0, g2 - c2 - C), m3 = Math.min(g2 + c2 + C, i4.plotHeight), e5.forEach((t4) => {
                ...
                (i5.dataLabels || []).forEach((h2) => {
                  let l3 = h2.options || {}, g3 = i5.distributeBox, f3 = h2.dataLabelPosition, m4 = (f3 == null ? void 0 : f3.natural.y) || 0, b3 = l3.connectorPadding || 0, C2 = h2.lineHeight || 21, k2 = (C2 - h2.getBBox().height) / 2, M = 0, w = m4, A = "inherit";
                  if (f3) {
                    if (d2 && p(g3) && f3.distance > 0 && (void 0 === g3.pos ? A = "hidden" : (S = g3.size, w = y.radialDistributionY(i5, h2))), l3.justify) M = y.justify(i5, h2, c2, a2);
                    ...
                    if (f3.attribs = { visibility: A, align: f3.alignment }, f3.posAttribs = { x: M + (l3.x || 0) + ({ left: b3, right: -b3 }[f3.alignment] || 0), y: w + (l3.y || 0) - C2 / 2 }, f3.computed.x = M, f3.computed.y = w - k2, u(l3.crop, true)) {
                      let t4;
